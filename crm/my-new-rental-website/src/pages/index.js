...
// In your Home function, update the navigation functions:
const nextProperties = () => {
  setCurrentIndex((prev) => (prev + 2 >= 3 ? 0 : prev + 2));  // Changed from 3 to 2
};
...
const prevProperties = () => {
  setCurrentIndex((prev) => (prev - 2 < 0 ? Math.max(0, 3 - 2) : prev - 2));  // Changed from 3 to 2
};
      return (
...
<nav className="bg-white shadow-sm relative">
  <div className="max-w-7xl mx-auto px-4">
    <div className="flex items-center">
      ...
      {/* Navigation Links - Moved left and adjusted spacing */}
      <div className="flex space-x-6"> {/* Reduced space between links */}
        <Link 
          href="/"
      ...
      {/* Auth buttons - Push to the right */}
